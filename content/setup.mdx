...
- **Project Rules:**  
  Stored in `.cursor/rules` inside your repo, version-controlled, and can be scoped to specific directories.
- **User Rules:**  
  Defined in Cursor's global settings, always applied in your environment.
- **Legacy Rules:**  
  `.cursorrules` in project root (deprecated).
